...
mysqli_query($koneksi, $query); //mengeksekusi variabel
?>
</head>
<body>
	
	<table width="300" border="2"> <!--membuat tabel-->
		<tr>
			<th>No</th>
		...
		$data = mysqli_query($koneksi,"select * from siswa"); //membuat variabel data
		$no = 1;
	...
	<center>
		<a target="_blank" href="reportsiswa.php">Export To Excel</a> <!--link untuk report data ke file excel -->
	</center>
 </body>
</html>